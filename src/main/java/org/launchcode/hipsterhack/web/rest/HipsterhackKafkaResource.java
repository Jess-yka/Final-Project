...
@RestController
@RequestMapping("/api/hipsterhack-kafka")
public class HipsterhackKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HipsterhackKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HipsterhackKafkaResource(KafkaProperties kafkaProperties) {
